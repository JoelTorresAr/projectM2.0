                      ...
                      <v-row>
                        ...
                        <v-col cols="6">
                          <v-autocomplete
                            ...
                            no-data-text="No hay categorias registradas"
                        ...
                        <v-col cols="6">
                          <v-select
                            ...
                            no-data-text="No tiene estantes asignados"
                        ...
                        <v-col cols="6">
                          <v-autocomplete
                            ...
                            @change="clearOffer"
                            no-data-text="No hay offertas registradas"
...
export default {
  ...
  watch: {
    ...
    subsidiary_selected(val) {
      this.articles = [];
      this.shelves = [];
      (this.buttonDisable = false), (this.loading = true);
